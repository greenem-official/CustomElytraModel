...
public class WingsAnimation {
        public static final AnimationDefinition WINGS_OPEN = AnimationDefinition.Builder.withLength(0.5F)
        ...
        public static final AnimationDefinition WINGS_CROUCH = AnimationDefinition.Builder.withLength(0.5F)
                .addAnimation("right_wing", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
        ...
        public static final AnimationDefinition WINGS_CLOSE = AnimationDefinition.Builder.withLength(0.5F)
                .addAnimation("right_wing", new AnimationChannel(AnimationChannel.Targets.ROTATION,
        ...
        public static final AnimationDefinition WINGS_IDLE = AnimationDefinition.Builder.withLength(1.5F).looping()
                .addAnimation("right_wing", new AnimationChannel(AnimationChannel.Targets.ROTATION,
